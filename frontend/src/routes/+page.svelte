<script lang="ts">
  ...
  let templates: Template[] = [
    { id: 1, tool: "resize", format: "$1x$2", template: "Resize: $1n×$2n", value: [] },
    { id: 2, tool: "rotate", format: "$1", template: "Rotate by $1n degrees", value: [] },
  ];
...
<section class="space-y-4 p-6">
  ...
  >
    {#each templates as t (t.id)}
      <div class="p-2 bg-gray-100 rounded shadow drag-handle">
