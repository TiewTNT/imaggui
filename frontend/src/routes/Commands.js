...
export const all_templates_grouped = [
  ...
  },
  {
    name: "Text", commands: [
      ...
      { id: nanoid(), format: `-font $4 -draw "text $1,$2 '$3'"`, template: "Draw at $1n,$2n: \"$3t\" with font $4s{Sans Serif:DejaVu-Sans;Serif:DejaVu-Serif;Monospace:DejaVu-Sans-Mono;}", value: ["25", "65", "Hello", "DejaVu-Sans-Mono"], name: "Draw Text" },
