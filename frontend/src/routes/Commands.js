...
export const all_templates_grouped = [
  {
    name: "Geometry & Transform", commands: [
      { id: nanoid(), format: "-resize $1x$2", template: "Resize to $1n×$2n", value: ["1000", "1000"], name: "Resize", type: "in", tooltip: "Resize the image to the specified width and height in pixels." },
      ...
      { id: nanoid(), format: "-crop $1x$2+$3+$4", template: "Crop to $1n×$2n at ($3n,$4n)", value: ["300", "300", "0", "0"], name: "Crop", type: "in", tooltip: "Crop the image to the specified size starting from the given coordinates." },
      ...
      { id: nanoid(), format: "-border $1", template: "Add $1n px border", value: ["5"], name: "Border", type: "in", tooltip: "Add a uniform border of the specified width around the image." }
    ]
  },
  {
  ...
  },
  {
    name: "Other / Metadata", commands: [
      { id: nanoid(), format: "-quality $1", template: "JPEG quality $1n", value: ["85"], name: "JPEG Quality", type: "po", tooltip: "Set the output image quality (mostly for JPEG)." },
